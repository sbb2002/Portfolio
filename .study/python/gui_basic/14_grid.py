...
# 꿀팁=====================================================
# Ctrl + F 에서 > 버튼을 누르면
# Find 뿐만 아니라 Replace도 가능하다.
# 이것으로 반복작업할 때 손쉽게 붙여넣을 수 있다!
# =========================================================

# 계산기
# 펑션 키
btn_f16 = Button(root, text="F16", width=5, height=2)    # 버튼 내 여백->padx, pady / height, width로도 조절 가능
btn_f17 = Button(root, text="F17", width=5, height=2)
btn_f18 = Button(root, text="F18", width=5, height=2)
btn_f19 = Button(root, text="F19", width=5, height=2)

btn_f16.grid(row=0, column=0, sticky=N+E+W+S, padx=3, pady=3)   # 동서남북sticky
btn_f17.grid(row=0, column=1, sticky=N+E+W+S, padx=3, pady=3)   # 그리드 여백
