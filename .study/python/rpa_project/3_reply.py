...
# [선정 안내 메일]
# 제목: 파이썬 특강 안내 [선정]
# 본문: xx님 축하합니다! 특강 대상자로 선정되셨습니다. (선정순번 1번)

# [탈락 안내 메일]
# 제목: 파이썬 특강 안내 [탈락]
# 본문: xx님 아쉽게도 탈락입니다. 취소 인원이 발생할 경우 연락드리겠습니다. (대기순번 1번)
...
with smtplib.SMTP("smtp.gmail.com", 587) as smtp:
    ...
    for applicant in applicant_list:
        ...
        # phone = applicant[3]
        index, nickname, phone = applicant[1:]  # [1] ~ 끝까지[3]
        ...
        if index <= max_val:
            title = "파이썬 특강 안내 [선정]"
            content = "{}님 축하드립니다! 특강 대상자로 선정되셨습니다. (선정순번 1번).".format(nickname)
        else:
            title = "파이썬 특강 안내 [탈락]"
